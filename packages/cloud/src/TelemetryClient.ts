/* eslint-disable @typescript-eslint/no-unused-vars */ /* novelweave_change this file is meant to be a stub */
import {
...
abstract class BaseTelemetryClient implements TelemetryClient {
	...
	public abstract updateIdentity(novelweaveToken: string): Promise<void>
...
export class CloudTelemetryClient extends BaseTelemetryClient {
	...
	public override captureException(error: Error, properties?: Record<string | number, unknown>): void {} // novelweave_change

	public override async updateIdentity(novelweaveToken: string): Promise<void> {} // novelweave_change
