...
const novelweaveSchema = baseProviderSettingsSchema.extend({
	novelweaveToken: z.string().optional(),
	novelweaveOrganizationId: z.string().optional(),
	novelweaveModel: z.string().optional(),
	openRouterSpecificProvider: z.string().optional(),
	openRouterProviderDataCollection: openRouterProviderDataCollectionSchema.optional(),
	openRouterProviderSort: openRouterProviderSortSchema.optional(),
	openRouterZdr: z.boolean().optional(),
	novelweaveTesterWarningsDisabledUntil: z.number().optional(), // Timestamp for disabling NOVELWEAVE-TESTER warnings
})
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	ovhcloudSchema.merge(z.object({ apiProvider: z.literal("ovhcloud") })), // novelweave_change
	...
	novelweaveSchema.merge(z.object({ apiProvider: z.literal("novelweave") })),
...
export const providerSettingsSchema = z.object({
	...
	...ovhcloudSchema.shape, // novelweave_change
})
...
export const modelIdKeysByProvider: Record<TypicalProvider, ModelIdKey> = {
	...
	"novelweave-openrouter": "openRouterModelId",
	bedrock: "apiModelId",
	vertex: "apiModelId",
	...
	synthetic: "apiModelId", // novelweave_change
	featherless: "apiModelId",
	"io-intelligence": "ioIntelligenceModelId",
	roo: "apiModelId",
	"vercel-ai-gateway": "vercelAiGatewayModelId",
	novelweave: "novelweaveModel",
	"virtual-quota-fallback": "apiModelId",
	ovhcloud: "ovhCloudAiEndpointsModelId", // novelweave_change
}
...
> = {
	...
	ovhcloud: { id: "ovhcloud", label: "OVHcloud AI Endpoints", models: [] }, // novelweave_change

	// novelweave_change start
	novelweave: { id: "novelweave", label: "Novelweave", models: [] },
	"novelweave-openrouter": { id: "novelweave-openrouter", label: "Novelweave", models: [] }, // temporarily needed to satisfy because we're using 2 inconsistent names apparently
