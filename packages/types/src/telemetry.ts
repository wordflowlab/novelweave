...
export const staticAppPropertiesSchema = z.object({
	...
	platform: z.string(),
	editorName: z.string(),
	wrapped: z.boolean(), // novelweave_change
	wrapper: z.string().nullable(), // novelweave_change
	wrapperTitle: z.string().nullable(), // novelweave_change
	wrapperCode: z.string().nullable(), // novelweave_change
	wrapperVersion: z.string().nullable(), // novelweave_change
...
export const rooCodeTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
			// novelweave_change start
			TelemetryEventName.COMMIT_MSG_GENERATED, // novelweave_change
			TelemetryEventName.INLINE_ASSIST_QUICK_TASK, // novelweave_change
			TelemetryEventName.INLINE_ASSIST_AUTO_TASK, // novelweave_change
			TelemetryEventName.INLINE_ASSIST_ACCEPT_SUGGESTION, // novelweave_change
			TelemetryEventName.INLINE_ASSIST_REJECT_SUGGESTION, // novelweave_change
			TelemetryEventName.WEBVIEW_MEMORY_USAGE, // novelweave_change
			// novelweave_change end
...
export interface TelemetryClient {
	...
	updateIdentity(novelweaveToken: string): Promise<void>
	// novelweave_change end
