...
import { fastApplyModelSchema, ghostServiceSettingsSchema } from "./novelweave.js" // novelweave_change
...
export const globalSettingsSchema = z.object({
	...
	allowVeryLargeReads: z.boolean().optional(), // novelweave_change
	...
	showAutoApproveMenu: z.boolean().optional(), // novelweave_change
	showTaskTimeline: z.boolean().optional(), // novelweave_change
	showTimestamps: z.boolean().optional(), // novelweave_change
	hideCostBelowThreshold: z.number().min(0).optional(), // novelweave_change
	localWorkflowToggles: z.record(z.string(), z.boolean()).optional(), // novelweave_change
	globalWorkflowToggles: z.record(z.string(), z.boolean()).optional(), // novelweave_change
	localRulesToggles: z.record(z.string(), z.boolean()).optional(), // novelweave_change
	globalRulesToggles: z.record(z.string(), z.boolean()).optional(), // novelweave_change
	...
	systemNotificationsEnabled: z.boolean().optional(), // novelweave_change
	...
	// novelweave_change start: Morph fast apply
	...
	mcpMarketplaceCatalog: z.any().optional(), // novelweave_change: MCP marketplace catalog
	...
	dismissedNotificationIds: z.string().array().optional(), // novelweave_change
	commitMessageApiConfigId: z.string().optional(), // novelweave_change
	terminalCommandApiConfigId: z.string().optional(), // novelweave_change
	ghostServiceSettings: ghostServiceSettingsSchema, // novelweave_change
...
export const SECRET_STATE_KEYS = [
	...
	"ovhCloudAiEndpointsApiKey", // novelweave_change
] as const
...
export const EVALS_SETTINGS: RooCodeSettings = {
	...
	systemNotificationsEnabled: true, // novelweave_change
