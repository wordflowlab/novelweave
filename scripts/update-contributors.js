...
const CONTRIBUTORS_JSON_URL = "https://novelweave.ai/contributors.json"
const MAX_CONTRIBUTORS_DISPLAY = 9
const CONTRIBUTORS_PAGE_URL = "https://novelweave.ai/#contributors"
...
function generateContributorMarkdown(contributors) {
	...
	const validContributors = contributors.map((contributor) => {
		// Convert novelweave.ai format to GitHub-like format
		return {
...
async function updateContributorsSection() {
	try {
		console.log("Fetching contributors from novelweave.ai...")
