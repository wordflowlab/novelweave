...
2. **Node.js** (version [v20.19.2](https://github.com/Kilo-Org/novelweave/blob/main/.nvmrc) recommended)
...
1. **Report an issue** using [GitHub Issues](https://github.com/Kilo-Org/novelweave/issues)
...
5. **Suggest a new feature** using [GitHub Discussions](https://github.com/Kilo-Org/novelweave/discussions/categories/ideas)!
