# NovelWeave Development Guide

Welcome to the NovelWeave development guide! This document will help you set up your development environment and understand how to work with the codebase. Whether you're fixing bugs, adding features, or just exploring the code, this guide will get you started.
...
2. **Node.js** (version [v20.19.2](https://github.com/NovelWeave-Org/novelweave/blob/main/.nvmrc) recommended)
...
2.  **Type Generation**: Runs `pnpm --filter novelweave generate-types`.
...
We welcome contributions to NovelWeave! Here's how you can help:

1. **Report an issue** using [GitHub Issues](https://github.com/NovelWeave-Org/novelweave/issues)
2. **Find an issue** and submit a Pull Request with your fix
3. **Write tests** to improve Code Coverage
4. **Improve Documentation** at [novelweave.ai/docs](https://novelweave.ai/docs)
5. **Suggest a new feature** using [GitHub Discussions](https://github.com/NovelWeave-Org/novelweave/discussions/categories/ideas)!
