...
async function showCurrentModel(context: any): Promise<void> {
	const { currentProvider, routerModels, novelweaveDefaultModel, addMessage } = context
...
async function selectModel(context: any, modelId: string): Promise<void> {
	const { currentProvider, routerModels, novelweaveDefaultModel, updateProviderModel, addMessage } = context
...
async function modelAutocompleteProvider(context: ArgumentProviderContext) {
	...
	const { currentProvider, routerModels, novelweaveDefaultModel } = context.commandContext
