 ...
 * Assumes the extension is bundled in dist/novelweave/
 *
 * Production structure:
 * cli/dist/
 * ├── index.js
 * ├── cli/NovelWeaveCLI.js
...
export function resolveExtensionPaths(): ExtensionPaths {
	...
	// Extension is in dist/novelweave/
	const extensionRootPath = path.join(distDir, "novelweave")
