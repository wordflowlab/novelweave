...
export class NovelWeavePaths {
	private static readonly BASE_DIR_NAME = ".novelweave"
	...
	/**
	 * Get base .novelweave/cli directory in user home
	 */
	static getNovelWeaveDir(): string {
	...
	static getLogsDir(): string {
		return path.join(this.getNovelWeaveDir(), "logs")
	}
	...
	static getGlobalStorageDir(): string {
		return path.join(this.getNovelWeaveDir(), "global")
	}
	...
	static getWorkspacesDir(): string {
		return path.join(this.getNovelWeaveDir(), "workspaces")
	}
	...
	static initializeWorkspace(workspacePath: string): void {
		...
		this.ensureDirectoryExists(this.getNovelWeaveDir())
