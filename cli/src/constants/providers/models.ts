...
export const PROVIDER_TO_ROUTER_NAME: Record<ProviderName, RouterName | null> = {
	novelweave: "novelweave-openrouter",
 ...
 * Mirrors the logic from webview-ui/src/components/novelweave/hooks/useProviderModels.ts
 *
...
export function getModelsByProvider(params: {
	...
	const { provider, routerModels, novelweaveDefaultModel } = params
	...
	if (routerName && routerModels && routerModels[routerName]) {
		...
		return {
			...
			defaultModel: provider === "novelweave" ? novelweaveDefaultModel : defaultModelId,
		}
	}
 ...
 * Mirrors the logic from webview-ui/src/components/novelweave/hooks/useSelectedModel.ts
 */
...
export function getCurrentModelId(params: {
	...
	const { providerConfig, routerModels, novelweaveDefaultModel } = params
 ...
 * Mirrors the logic from webview-ui/src/components/ui/hooks/novelweave/usePreferredModels.ts
 */
