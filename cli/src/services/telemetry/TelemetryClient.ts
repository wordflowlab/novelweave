...
export class TelemetryClient {
	...
	public async updateNovelweaveUserId(novelweaveToken: string): Promise<void> {
		...
		await identityManager.updateNovelweaveUserId(novelweaveToken)
	...
	public clearNovelweaveUserId(): void {
		const identityManager = getIdentityManager()
		identityManager.clearNovelweaveUserId()
		this.identity = identityManager.getIdentity()
	}
	...
	private getBaseProperties(): BaseProperties {
		...
		// Only include novelweaveUserId if it exists
		if (this.identity.novelweaveUserId) {
			baseProps.novelweaveUserId = this.identity.novelweaveUserId
		}
