...
<img src="/docs/img/task-todo-list/task-todo-list-1.png" alt="任务待办事项列表概述，显示 NovelWeave 中的交互式清单" width="500" />
...
- 要求 NovelWeave“使用 [update_todo_list 工具](/features/tools/update-todo-list)”
- 说“创建待办事项列表”

**底线**：NovelWeave 决定列表中包含什么，但您可以在批准对话框中提供反馈。
...
**现在**：NovelWeave 创建结构化清单，随着工作的进展自动更新。您清楚地知道自己所处的位置以及接下来要做什么。
...
- 查看所有项目及其状态
- 当 NovelWeave 请求批准时编辑描述
- 使用“编辑”按钮暂存更改

**3. 环境详细信息**
后台“提醒”表，让 NovelWeave 了解当前进度
...
**“可以创建自己的待办事项列表吗？”**
是的，只需要求 NovelWeave 使用 update_todo_list 工具。但 NovelWeave 仍控制内容和工作流。

**“简单的任务怎么办？”**
NovelWeave 通常会跳过简单任务的待办事项列表。开销不值得。

**“为什么不能直接编辑列表？”**
设计选择。NovelWeave 保持对任务管理的控制，以确保一致的进度跟踪。您提供输入，NovelWeave 执行。
