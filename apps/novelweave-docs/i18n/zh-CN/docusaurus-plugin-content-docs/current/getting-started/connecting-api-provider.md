...
- **Kilo Code API 提供商（推荐）：** 以有竞争力的价格提供对 OpenRouter 可用的所有模型的访问权限，并提供免费积分以供入门。 [查看定价](https://novelweave.ai/pricing)
...
## 使用 Kilo Code 提供商
默认情况下，当您安装 Kilo Code 扩展时，系统会提示您在 [Kilo Code 提供商](/providers/novelweave)中登录或创建帐户。
