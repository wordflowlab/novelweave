...
2. Click the NovelWeave logo next to the commit message field
...
The feature is available in NovelWeave since `v4.35` and became customizable in `v4.38`. Just make sure you have some staged changes, and look for the NovelWeave logo in your VS Code Source Control panel.
