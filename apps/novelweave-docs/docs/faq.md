...
- If the problem persists, report the issue on [GitHub](https://github.com/Kilo-Org/novelweave/issues) or [Discord](https://novelweave.ai/discord).
...
Please report bugs or suggest features on the Kilo Code [Issues page](https://github.com/Kilo-Org/novelweave/issues) and [Feature Requests page](https://github.com/Kilo-Org/novelweave/discussions/categories/ideas).
