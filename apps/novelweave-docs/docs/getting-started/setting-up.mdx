...
NovelWeave provides a simple registration process that gives you access to the latest frontier coding models with your NovelWeave login.

1. Click on "Try NovelWeave for Free" in the extension
...
<img
  ...
  alt="Sign up and registration flow with NovelWeave"
/>
