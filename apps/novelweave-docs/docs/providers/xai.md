...
# Using xAI (Grok) With NovelWeave
...
3.  **Create a Key:** Click to create a new API key. Give your key a descriptive name (e.g., "NovelWeave").
4.  **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

## Supported Models

NovelWeave supports the following xAI Grok models:
