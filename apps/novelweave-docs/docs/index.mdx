...
# NovelWeave Documentation

NovelWeave **accelerates** development with AI-driven code generation and task automation. This open source extension plugs directly into VS Code.
...
1. [Install NovelWeave](/getting-started/installing)
2. [Set up NovelWeave](/getting-started/setting-up)
3. [Try Your First Task](/getting-started/your-first-task)

## Features

<Image src="/docs/img/kilogif.gif" alt="GIF showing some of the capabilities of NovelWeave" width="600" />

### Basics

Use [the chat interface](/basic-usage/the-chat-interface) to tell NovelWeave what you need. It relies on coding‑optimized AI models to complete each request.
...
#### Multiple Modes
NovelWeave adapts to your needs with specialized [modes](/basic-usage/using-modes):
...
#### Core Tools
NovelWeave comes with powerful [tools](/features/tools/tool-use-overview) that can:
...
- **[Local Models](/advanced-usage/local-models):** Run NovelWeave with local AI models for offline use or enhanced privacy

### Customizing NovelWeave
Make NovelWeave work your way with:
...
### Documentation
- [Using NovelWeave](/basic-usage/the-chat-interface) - Learn the basics
...
- **YouTube:** <a href={YOUTUBE_URL} target="_blank">Check out our YouTube</a> to learn hands on skills when using NovelWeave
...
Ready to get started? Click the **Next** button below to begin your journey with NovelWeave!
