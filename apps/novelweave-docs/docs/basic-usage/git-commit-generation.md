...
Generate descriptive commit messages automatically based on your staged git changes. NovelWeave analyzes your staged files and creates conventional commit messages that follow best practices.
...
2. In the VS Code Source Control panel, look for the `NovelWeave` logo next to the commit message field)
...
- [Settings Management](/features/settings-management) - Manage all your NovelWeave preferences
