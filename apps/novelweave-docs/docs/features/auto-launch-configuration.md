...
1. Create a `.novelweave` directory in your workspace root (if it doesn't exist)
2. Create a `launchConfig.json` file inside the `.novelweave` directory
...
1. Verify file location: `.novelweave/launchConfig.json` in workspace root
