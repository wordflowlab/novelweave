...
NovelWeave implements the Model Context Protocol to:
...
- [Using MCP in NovelWeave](/features/mcp/using-mcp-in-novelweave) - Get started with MCP in NovelWeave, including creating simple servers
