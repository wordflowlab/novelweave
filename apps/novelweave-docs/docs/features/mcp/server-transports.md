...
For detailed information on configuring STDIO and SSE transports in Kilo Code, including example configurations, see the [Understanding Transport Types](/features/mcp/using-mcp-in-novelweave#understanding-transport-types) section in the Using MCP in Kilo Code guide.