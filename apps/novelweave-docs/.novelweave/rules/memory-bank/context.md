...
The NovelWeave documentation site is a mature, production-ready Docusaurus project that serves as the comprehensive documentation hub for the NovelWeave VS Code extension. The site is hosted at https://novelweave.ai/docs and provides extensive documentation covering installation, usage, features, and extension capabilities.
...
- **Using NovelWeave**: Chat interface, modes, context mentions, and basic features
...
- **Extending NovelWeave**: Model providers (18+ supported), local models, MCP integration, shell integration
