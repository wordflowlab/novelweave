...
export const EmptyWithNotificationsAndHistory: Story = {
	...
	decorators: [
		(Story) => {
			// Mock notifications for NovelweaveNotifications component
			React.useEffect(() => {
				const mockNotifications = [
					{
						...
						action: {
							...
							actionURL: "https://novelweave.com/features/code-analysis",
						},
					},
					{
						id: "notification-2",
				...
				// Simulate the message event that NovelweaveNotifications listens for
	...
	parameters: {
		extensionState: {
			...
			apiConfiguration: {
				apiProvider: "novelweave", // Set to novelweave to show notifications
				apiModelId: "claude-3-5-sonnet-20241022",
				apiKey: "mock-key",
			},
			mcpServers: [],
