...
// novelweave_change: baseUrl, apiKey
async function getOpenRouterProvidersForModel(modelId: string, baseUrl?: string, apiKey?: string) {
	...
	try {
		// novelweave_change start: baseUrl, apiKey
		...
		for (const endpoint of endpoints) {
			const providerName = endpoint.tag ?? endpoint.provider_name // novelweave_change
...
// novelweave_change start: baseUrl, apiKey, organizationId
