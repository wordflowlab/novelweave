...
import { ExtensionStateContextProvider } from "@src/context/ExtensionStateContext" // novelweave_change
...
const createWrapper = () => {
	...
	// novelweave_change start: wrap with ExtensionStateContextProvider
