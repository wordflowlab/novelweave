...
import {
	...
	DialogFooter,
	ToggleSwitch,
	// StandardTooltip, // novelweave_change: not used
...
// import McpEnabledToggle from "./McpEnabledToggle" // novelweave_change not used
...
const McpView = ({ onDone, hideHeader = false }: McpViewProps) => {
	...
	return (
		// novelweave_change: add relative className
		<Tab className="relative">
			{/*  novelweave_change: display header conditionally */}
			...
			<TabContent>
				<div
					...
					<Trans i18nKey="mcp:description">
						<VSCodeLink
							href={buildDocLink("features/mcp/using-mcp-in-novelweave", "mcp_settings")}
				...
				{/* <McpEnabledToggle /> novelweave_change: we always enable MCP */}

				{mcpEnabled && (
					<>
						{/* novelweave_change: display: none; we always allow mcp server creation */}
						<div style={{ display: "none", marginBottom: 15 }}>
							...
							<div
								...
								<Trans i18nKey="mcp:enableServerCreation.description">
									<VSCodeLink
										href={buildDocLink(
											"features/mcp/using-mcp-in-novelweave#how-to-use-novelweave-to-create-an-mcp-server",
											"mcp_server_creation",
										)}
										style={{ display: "inline" }}>
						...
						<div
							...
							<VSCodeLink
								href={buildDocLink(
									"features/mcp/using-mcp-in-novelweave#editing-mcp-settings-files",
									"mcp_edit_settings",
								)}
								style={{ display: "inline" }}>
