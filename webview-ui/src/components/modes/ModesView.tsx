...
import { OrganizationModeWarning } from "../novelweave/OrganizationModeWarning"
	...
	return (
		<Tab>
			...
			<TabContent>
				...
				{/* Name section */}
				<div className="mb-5">
					{isOrganizationMode && <OrganizationModeWarning />} {/* novelweave_change start */}
					...
					<div className="mb-4">
						<div className="flex justify-between items-center mb-1">
							...
							{/* novelweave_change: Added !isOrganizationMode check */}
						...
						<VSCodeTextArea
							...
							// novelweave_change disable editing for org modes
					...
					<div className="mb-4">
						<div className="flex justify-between items-center mb-1">
							...
							{/* novelweave_change don't show for org modes */}
							{!findModeBySlug(visualMode, customModes) && !isOrganizationMode && (
									...
									span: (
										<span
											...
											onClick={() => {
												...
												vscode.postMessage({
													type: "openFile",
													text: `./.novelweave/rules-${currentMode.slug}/rules.md`,
													values: {
														create: true,
														content: "",
													},
												...
												span: (
													<span
														...
														onClick={() => {
															...
															vscode.postMessage({
																type: "openFile",
																text: `./.novelweave/system-prompt-${currentMode.slug}`, // novelweave_change
																values: {
																	create: true,
																	content: "",
																},
								...
								span: (
									<span
										...
										onClick={() =>
											vscode.postMessage({
												type: "openFile",
												text: "./.novelweave/rules/rules.md",
												values: {
													create: true,
													content: "",
												},
