...
const SlashCommandMenu: React.FC<SlashCommandMenuProps> = ({
	...
	const { localWorkflows, globalWorkflows } = useExtensionState() // novelweave_change
	...
	const filteredCommands = getMatchingSlashCommands(query, customModes, localWorkflows, globalWorkflows) // novelweave_change
