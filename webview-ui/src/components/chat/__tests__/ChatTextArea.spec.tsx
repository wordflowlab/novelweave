...
import { useQuery } from "@tanstack/react-query" // novelweave_change
import { HistoryItem } from "@roo-code/types" // novelweave_change
...
describe("ChatTextArea", () => {
	...
	// novelweave_change: skip because we have our own slash commands
	...
	// novelweave_change: removed in novelweave
