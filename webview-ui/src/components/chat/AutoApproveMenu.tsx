...
import { MaxRequestsInput } from "../settings/MaxRequestsInput" // novelweave_change
import { MaxCostInput } from "../settings/MaxCostInput" // novelweave_change
...
const AutoApproveMenu = ({ style }: AutoApproveMenuProps) => {
	...
	const {
		...
		allowedMaxRequests, // novelweave_change
		allowedMaxCost, // novelweave_change
		...
		setAllowedMaxRequests, // novelweave_change
		setAllowedMaxCost, // novelweave_change
	} = useExtensionState()
