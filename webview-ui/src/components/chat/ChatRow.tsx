...
import { LowCreditWarning } from "../novelweave/chat/LowCreditWarning" // novelweave_change
...
import { StandardTooltip } from "../ui" // novelweave_change
import { FastApplyChatDisplay } from "./novelweave/FastApplyChatDisplay" // novelweave_change
import { appendImages } from "@src/utils/imageUtils"
import { McpExecution } from "./McpExecution"
import { ChatTextArea } from "./ChatTextArea"
import { MAX_IMAGES_PER_MESSAGE } from "./ChatView"
import { InvalidModelWarning } from "../novelweave/chat/InvalidModelWarning" // novelweave_change
...
import { SeeNewChangesButtons } from "./novelweave/SeeNewChangesButtons"
import ChatTimestamps from "./ChatTimestamps" // novelweave_change
...
interface ChatRowProps {
	...
	highlighted?: boolean // novelweave_change: Add highlighted prop
	enableCheckpoints?: boolean // novelweave_change
...
const ChatRow = memo(
	(props: ChatRowProps) => {
		...
		const [chatrow, { height }] = useSize(
			<div
				// novelweave_change: add highlighted className
				className={cn(
...
export const ChatRowContent = ({
	...
	// novelweave_change: add showTimestamps
	...
	// novelweave_change: usageMissing, inferenceProvider
	...
	// novelweave_change start: hide cost display check
	...
	// novelweave_change end: hide cost display check
	...
	const [icon, title] = useMemo(() => {
			...
			case "api_req_started":
				...
				return [
					...
					apiReqCancelReason !== null && apiReqCancelReason !== undefined ? (
						...
						// novelweave_change start: tooltip
		...
		t,
		isExpanded,
		inferenceProvider, // novelweave_change
	])
						...
						<>
							<div
								...
								</div>
								{
									// novelweave_change start
									!cost && usageMissing && (
										<StandardTooltip content={t("novelweave:pricing.costUnknownDescription")}>
											<div className="flex items-center text-xs text-vscode-dropdown-foreground border-vscode-dropdown-border/50 border px-1.5 py-0.5 rounded-lg whitespace-nowrap">
												...
												{t("novelweave:pricing.costUnknown")}
											</div>
										</StandardTooltip>
									)
									// novelweave_change end
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ color: normalColor, fontWeight: "bold" }}>
									{t("novelweave:chat.condense.wantsToCondense")}
								</span>
							</div>
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ color: normalColor, fontWeight: "bold" }}>
									NovelWeave wants to create a Github issue:
								</span>
							</div>
