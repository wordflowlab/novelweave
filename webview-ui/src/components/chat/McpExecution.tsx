...
interface McpExecutionProps {
	...
	initiallyExpanded?: boolean // novelweave_change: For Storybook stories only
}
...
export const McpExecution = ({
	...
	initiallyExpanded = false, // novelweave_change
}: McpExecutionProps) => {
	...
	// novelweave_change: Main collapse state for the entire MCP execution content
	...
	// novelweave_change: Only parse response data when main content is expanded AND complete to avoid parsing partial JSON
	...
	return (
		<>
			<div
				...
				onClick={onToggleResponseExpand /* novelweave_change */}>
				...
				<div className="flex flex-row items-center justify-between gap-2 px-1">
					...
					{/* novelweave_change start - moved Chevron button */}
					<Button
						variant="ghost"
						size="icon"
						onClick={(e) => {
					...
					{/* novelweave_change end - moved Chevron button */}
				</div>
			</div>
