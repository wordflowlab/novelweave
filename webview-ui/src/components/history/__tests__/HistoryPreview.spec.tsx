...
vi.mock("@/novelweave/hooks/useTaskHistory")
...
const mockNovelWeaveTaskHistoryVersion = 0
...
describe("HistoryPreview", () => {
	...
	it("renders nothing when no tasks are available", () => {
		...
		const { container } = render(<HistoryPreview taskHistoryVersion={mockNovelWeaveTaskHistoryVersion} />)
	...
	it("renders up to 3 tasks when tasks are available", () => {
		...
		render(<HistoryPreview taskHistoryVersion={mockNovelWeaveTaskHistoryVersion} />)
