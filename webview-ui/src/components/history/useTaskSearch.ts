import {
	useState,
	useEffect,
	// useMemo, // novelweave_change
} from "react"
// import { Fzf } from "fzf"

// import { highlightFzfMatch } from "@/utils/highlight" // novelweave_change
...
export const useTaskSearch = () => {
	const { taskHistoryFullLength, taskHistoryVersion } = useExtensionState() // novelweave_change
	...
	// novelweave_change start: logic moved to src/core/novelweave/webview/getTaskHistory.ts
	//const presentableTasks = useMemo(() => {
	//	const taskHistory = data?.historyItems ?? [] // novelweave_change
	...
	//	// novelweave_change end
	//	return tasks
	//}, [data, showAllWorkspaces, showFavoritesOnly, cwd]) // novelweave_change
	//
	//const fzf = useMemo(() => {
	...
	return {
		tasks: data?.historyItems ?? [], // novelweave_change
		searchQuery,
		setSearchQuery,
		sortOption,
		setSortOption,
