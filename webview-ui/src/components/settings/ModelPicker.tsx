import { useState, useCallback, useEffect, useRef, Fragment } from "react" // novelweave_change Fragment
...
import { usePreferredModels } from "@/components/ui/hooks/novelweave/usePreferredModels" // novelweave_change
// import { filterModels } from "./utils/organizationFilters" // novelweave_change: not doing this
...
import {
	...
	PopoverTrigger,
	Button,
	SelectSeparator, // novelweave_change
} from "@src/components/ui"
import { useEscapeKey } from "@src/hooks/useEscapeKey"

import { ModelInfoView } from "./ModelInfoView"
import { ApiErrorMessage } from "./ApiErrorMessage"
import { NovelweaveModelInfoView } from "../novelweave/settings/ModelInfoView"
...
export const ModelPicker = ({
	...
	// organizationAllowList, // novelweave_change: unused
	errorMessage,
}: ModelPickerProps) => {
	...
	return (
		<>
			...
			{errorMessage && <ApiErrorMessage errorMessage={errorMessage} />}
			{
				...
				selectedModelId &&
					selectedModelInfo &&
					(apiConfiguration.apiProvider === "novelweave" || apiConfiguration.apiProvider === "openrouter" ? (
						<NovelweaveModelInfoView
			...
			<div className="text-sm text-vscode-descriptionForeground">
				{
					...
					apiConfiguration.apiProvider === "novelweave" ? (
						<Trans i18nKey="novelweave:settings.provider.automaticFetch" />
					) : (
						<Trans
