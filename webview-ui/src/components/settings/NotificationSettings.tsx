import { HTMLAttributes } from "react" // novelweave_change
...
type NotificationSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	areSettingsCommitted?: boolean // novelweave_change
...
export const NotificationSettings = ({
	...
	areSettingsCommitted, // novelweave_change
	setCachedStateField,
	...props
	...
	const onTestNotificationClick = () => {
		vscode.postMessage({
			...
			notificationOptions: {
				title: t("novelweave:settings.systemNotifications.testTitle"),
				message: t("novelweave:settings.systemNotifications.testMessage"),
			},
			alwaysAllow: true,
		})
	}
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						...
						<span className="font-medium">{t("novelweave:settings.systemNotifications.label")}</span>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1">
						{t("novelweave:settings.systemNotifications.description")}
					</div>
				</div>
				{systemNotificationsEnabled && (
					<div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
						<Button
							...
							{t("novelweave:settings.systemNotifications.testButton")}
						</Button>
					</div>
				)}
				{/* novelweave_change end */}
