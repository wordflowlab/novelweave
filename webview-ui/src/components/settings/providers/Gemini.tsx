...
import type {
	OrganizationAllowList, // novelweave_change
	ProviderSettings,
} from "@roo-code/types"
...
export const Gemini = ({
	...
	const allowList = organizationAllowList ?? { allowAll: true, providers: {} } // novelweave_change
	...
	return (
		<>
			...
			<div>
				...
				{/* novelweave_change: ModelPicker added */}
				<ModelPicker
