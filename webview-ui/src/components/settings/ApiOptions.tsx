import React, { Fragment, memo, useCallback, useEffect, useMemo, useState } from "react" // novelweave_change Fragment
import { convertHeadersToObject } from "./utils/headers"
import { useDebounce } from "react-use"
import { VSCodeLink, VSCodeButton } from "@vscode/webview-ui-toolkit/react"
// import { ExternalLinkIcon } from "@radix-ui/react-icons" // novelweave_change
...
import {
	...
	VercelAiGateway,
	DeepInfra,
	OvhCloudAiEndpoints, // novelweave_change
} from "./providers"

import { MODELS_BY_PROVIDER, PROVIDERS } from "./constants"
import { inputEventTransform, noTransform } from "./transforms"
// import { ModelPicker } from "./ModelPicker" // novelweave_change
...
export interface ApiOptionsProps {
	...
	hideNovelWeaveButton?: boolean // novelweave_change
	currentApiConfigName?: string // novelweave_change
}
...
const ApiOptions = ({
	...
	errorMessage,
	setErrorMessage,
	hideNovelWeaveButton = false,
	currentApiConfigName, // novelweave_change
}: ApiOptionsProps) => {
	const { t } = useAppTranslation()
	const {
		organizationAllowList,
		uiKind, // novelweave_change
	...
	// novelweave_change start: queryKey, chutesApiKey, gemini
	...
	useDebounce(
		() => {
			if (selectedProvider === "openai") {
				...
				selectedProvider === "chutes" // novelweave_change
			) {
		...
		[
			...
			apiConfiguration?.chutesApiKey, // novelweave_change
			apiConfiguration?.ovhCloudAiEndpointsBaseUrl, // novelweave_change
			customHeaders,
		],
	)
	...
	const onProviderChange = useCallback(
		(value: ProviderName) => {
			...
			> = {
				...
				synthetic: { field: "apiModelId", default: syntheticDefaultModelId }, // novelweave_change
				featherless: { field: "apiModelId", default: featherlessDefaultModelId },
				ovhcloud: { field: "ovhCloudAiEndpointsModelId", default: ovhCloudAiEndpointsDefaultModelId }, // novelweave_change
				...
				// novelweave_change start
				novelweave: { field: "novelweaveModel", default: novelweaveDefaultModel },
		...
		[setApiConfigurationField, apiConfiguration, novelweaveDefaultModel],
	)
	...
	// novelweave_change start: no organizationAllowList
	...
	return (
		<div className="flex flex-col gap-3">
			...
			{/* novelweave_change start */}
			{selectedProvider === "novelweave" && (
				<NovelWeave
					apiConfiguration={apiConfiguration}
					setApiConfigurationField={setApiConfigurationField}
					hideNovelWeaveButton={hideNovelWeaveButton}
