...
import { TerminalCommandGeneratorSettings } from "./TerminalCommandGeneratorSettings" // novelweave_change
...
type TerminalSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	terminalCommandApiConfigId?: string // novelweave_change
			...
			<Section>
				...
				<div className="flex flex-col gap-3">
					...
					<div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
						...
						<div>
							<VSCodeCheckbox
								checked={terminalShellIntegrationDisabled ?? true /* novelweave_change: default */}
								onChange={(e: any) =>
