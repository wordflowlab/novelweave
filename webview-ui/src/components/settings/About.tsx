			...
			<Section>
				<div>
					...
					<p className="text-vscode-descriptionForeground text-sm mt-0">
						<Trans
							...
							components={{
								privacyLink: <VSCodeLink href="https://novelweave.ai/privacy" />,
							}}
						/>
					</p>
				</div>
				...
				<div>
					<Trans
						...
						components={{
							githubLink: <VSCodeLink href="https://github.com/wordflowlab/novel" />,
							redditLink: <VSCodeLink href="https://reddit.com/r/novelweave" />,
							discordLink: <VSCodeLink href="https://novelweave.ai/discord" />,
						}}
					/>
				</div>
				...
				<div>
					<Trans
						...
						components={{
							supportLink: <VSCodeLink href="https://novelweave.ai/support" />,
						}}
					/>
				</div>
