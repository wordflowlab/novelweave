...
vi.mock("@/components/ui", () => ({
	...
	SelectSeparator: () => <div data-testid="select-separator" />, // novelweave_change
...
// novelweave_change on next line, initial state initialization to work with localized checkboxes
