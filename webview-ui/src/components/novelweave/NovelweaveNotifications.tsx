...
export const NovelweaveNotifications: React.FC = () => {
	...
	useEffect(() => {
		const handleMessage = (event: MessageEvent) => {
			...
			if (message.type === "novelweaveNotificationsResponse") {
	...
	useEffect(() => {
		vscode.postMessage({ type: "fetchNovelweaveNotifications" })
	}, [])
	...
	return (
		<div className="novelweave-notifications flex flex-col mb-4">
