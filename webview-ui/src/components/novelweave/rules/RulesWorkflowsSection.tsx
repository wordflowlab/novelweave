...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
	...
	const globalSectionKey =
		type === "rule" ? "novelweave:rules.sections.globalRules" : "novelweave:rules.sections.globalWorkflows"
	const workspaceSectionKey =
		type === "rule" ? "novelweave:rules.sections.workspaceRules" : "novelweave:rules.sections.workspaceWorkflows"
