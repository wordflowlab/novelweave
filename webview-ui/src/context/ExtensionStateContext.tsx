...
import {
	...
	openRouterDefaultModelId, // novelweave_change
	type TodoItem,
...
import { McpMarketplaceCatalog } from "../../../src/shared/novelweave/mcp" // novelweave_change

import { vscode } from "@src/utils/vscode"
import { convertTextMateToHljs } from "@src/utils/textMateToHljs"
import { ClineRulesToggles } from "@roo/cline-rules" // novelweave_change

export interface ExtensionStateContextType extends ExtensionState {
	historyPreviewCollapsed?: boolean
	showTaskTimeline?: boolean // novelweave_change
	setShowTaskTimeline: (value: boolean) => void // novelweave_change
	showTimestamps?: boolean // novelweave_change
	setShowTimestamps: (value: boolean) => void // novelweave_change
	hideCostBelowThreshold?: number // novelweave_change
	setHideCostBelowThreshold: (value: number) => void // novelweave_change
	hoveringTaskTimeline?: boolean // novelweave_change
	setHoveringTaskTimeline: (value: boolean) => void // novelweave_change
	systemNotificationsEnabled?: boolean // novelweave_change
	setSystemNotificationsEnabled: (value: boolean) => void // novelweave_change
	dismissedNotificationIds: string[] // novelweave_change
	didHydrateState: boolean
	showWelcome: boolean
	theme: any
	mcpServers: McpServer[]
	mcpMarketplaceCatalog: McpMarketplaceCatalog // novelweave_change
	...
	allowVeryLargeReads?: boolean // novelweave_change
	...
	setShowAutoApproveMenu: (value: boolean) => void // novelweave_change
	...
	commitMessageApiConfigId?: string // novelweave_change
	setCommitMessageApiConfigId: (value: string) => void // novelweave_change
	markNotificationAsDismissed: (notificationId: string) => void // novelweave_change
	ghostServiceSettings?: GhostServiceSettings // novelweave_change
	setGhostServiceSettings: (value: GhostServiceSettings) => void // novelweave_change
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		version: "",
		clineMessages: [],
		taskHistoryFullLength: 0, // novelweave_change
		taskHistoryVersion: 0, // novelweave_change
		...
		alwaysAllowWrite: true, // novelweave_change
		alwaysAllowReadOnly: true, // novelweave_change
		...
		showAutoApproveMenu: false, // novelweave_change
		...
		allowVeryLargeReads: false, // novelweave_change
		terminalZshP10k: false, // Default Powerlevel10k integration setting
		terminalZdotdir: false, // Default ZDOTDIR handling setting
		terminalCompressProgressBar: true, // Default to compress progress bar output
		historyPreviewCollapsed: false, // Initialize the new state (default to expanded)
		showTaskTimeline: true, // novelweave_change
		showTimestamps: true, // novelweave_change
		novelweaveDefaultModel: openRouterDefaultModelId,
	...
	const [mcpMarketplaceCatalog, setMcpMarketplaceCatalog] = useState<McpMarketplaceCatalog>({ items: [] }) // novelweave_change
	...
	const contextValue: ExtensionStateContextType = {
		...
		theme,
		mcpServers,
		mcpMarketplaceCatalog, // novelweave_change
		currentCheckpoint,
		filePaths,
		openedTabs,
		// novelweave_change start
		...
		dismissedNotificationIds: state.dismissedNotificationIds || [], // novelweave_change
		// novelweave_change end
