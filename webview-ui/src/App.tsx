...
import WelcomeView from "./components/novelweave/Welcome/WelcomeView" // novelweave_change
import ProfileView from "./components/novelweave/profile/ProfileView" // novelweave_change
...
// import { AccountView } from "./components/account/AccountView" // novelweave_change: we have our own profile view
// import { CloudView } from "./components/cloud/CloudView" // novelweave_change: not rendering this
...
const App = () => {
	const {
		...
		renderContext,
		mdmCompliant,
		apiConfiguration, // novelweave_change
	} = useExtensionState()
	...
	const chatViewRef = useRef<ChatViewRef & { focusInput: () => void }>(null) // novelweave_change
	...
	return showWelcome ? (
		...
		<>
			...
			{tab === "settings" && (
				<SettingsView ref={settingsRef} onDone={() => switchTab("chat")} targetSection={currentSection} /> // novelweave_change
			)}
			...
			{tab === "marketplace" && (
				<MarketplaceView
					...
					// novelweave_change: targetTab="mode"
					targetTab="mode"
				/>
			)}
			{/* novelweave_change: no cloud view */}
			{/* {tab === "cloud" && (
				<CloudView
			...
			{/* novelweave_change: we have our own profile view */}
			{/* {tab === "account" && (
