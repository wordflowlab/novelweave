...
const USAGE_STORAGE_KEY = "novelweave.virtualQuotaFallbackProvider.usage.v1"
const COOLDOWNS_STORAGE_KEY = "novelweave.virtualQuotaFallbackProvider.cooldowns.v1"
