...
vi.mock("../../i18n", () => ({
	t: vi.fn((key: string, params?: any) => {
		const translations: Record<string, string> = {
			...
			"novelweave:terminalCommandGenerator.generatingProgress": "Generating terminal command...",
			"novelweave:terminalCommandGenerator.commandGenerated": `Generated command: ${params?.command || ""}`,
			"novelweave:terminalCommandGenerator.generationFailed": `Failed to generate command: ${params?.error || ""}`,
			"novelweave:terminalCommandGenerator.warningDialog.title": "Always Verify AI-Generated Commands",
			"novelweave:terminalCommandGenerator.warningDialog.message":
			...
			"novelweave:terminalCommandGenerator.warningDialog.okButton": "OK, I Understand",
			"novelweave:terminalCommandGenerator.warningDialog.cancelButton": "Cancel",
		}
