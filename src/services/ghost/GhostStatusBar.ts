...
export class GhostStatusBar {
	...
	private init() {
		this.statusBar.text = t("novelweave:ghost.statusBar.enabled")
		this.statusBar.tooltip = t("novelweave:ghost.statusBar.tooltip.basic")
		this.statusBar.show()
	}
	...
	private humanFormatCost(cost: number): string {
		if (cost === 0) return t("novelweave:ghost.statusBar.cost.zero")
		if (cost > 0 && cost < 0.01) return t("novelweave:ghost.statusBar.cost.lessThanCent") // Less than one cent
	...
	// 	this.statusBar.text = t("novelweave:ghost.statusBar.disabled")
	// 	this.statusBar.tooltip = t("novelweave:ghost.statusBar.tooltip.disabled")
	// }

	private renderTokenError() {
		this.statusBar.text = t("novelweave:ghost.statusBar.warning")
		this.statusBar.tooltip = t("novelweave:ghost.statusBar.tooltip.tokenError")
	}
	...
	private renderDefault() {
		...
		this.statusBar.text = `${t("novelweave:ghost.statusBar.enabled")} (${totalCostFormatted})`
		this.statusBar.tooltip = `\
${t("novelweave:ghost.statusBar.tooltip.basic")}
• ${t("novelweave:ghost.statusBar.tooltip.lastCompletion")} $${lastCompletionCostFormatted}
• ${t("novelweave:ghost.statusBar.tooltip.sessionTotal")} ${totalCostFormatted}
• ${t("novelweave:ghost.statusBar.tooltip.model")} ${this.model}\
`
	}
