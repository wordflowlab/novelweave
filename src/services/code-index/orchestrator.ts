...
export class CodeIndexOrchestrator {
	...
	private _cancelRequested: boolean = false // novelweave_change
	...
	public async startIndexing(): Promise<void> {
		...
		this._cancelRequested = false // novelweave_change
		...
		try {
			...
			const handleFileParsed = (fileBlockCount: number) => {
				if (this._cancelRequested) return // novelweave_change
