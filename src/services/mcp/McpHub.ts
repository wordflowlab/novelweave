...
import { NotificationService } from "./novelweave/NotificationService"
...
export class McpHub {
	...
	private async watchProjectMcpFile(): Promise<void> {
		...
		const projectMcpPattern = new vscode.RelativePattern(workspaceFolder, ".novelweave/mcp.json")
  ...
  "mcpServers": {
	...
	private async getProjectMcpPath(): Promise<string | null> {
		...
		const projectMcpDir = path.join(workspacePath, ".novelweave")
		...
		try {
			...
			// If not found in .novelweave/, fall back to .mcp.json in root directory
