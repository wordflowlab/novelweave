...
export const getModelMaxOutputTokens = ({
	...
	/* novelweave_change: don't limit Anthropic model output, no idea why this was done before
...
const dynamicProviderExtras = {
	gemini: {} as { apiKey?: string; baseUrl?: string }, // novelweave_change
	openrouter: {} as {}, // eslint-disable-line @typescript-eslint/no-empty-object-type
	"vercel-ai-gateway": {} as {}, // eslint-disable-line @typescript-eslint/no-empty-object-type
	huggingface: {} as {}, // eslint-disable-line @typescript-eslint/no-empty-object-type
	litellm: {} as { apiKey: string; baseUrl: string },
	"novelweave-openrouter": {} as { novelweaveToken?: string; novelweaveOrganizationId?: string }, // novelweave_change
	...
	ollama: {} as { numCtx?: number }, // novelweave_change
	lmstudio: {} as {}, // eslint-disable-line @typescript-eslint/no-empty-object-type
	ovhcloud: {} as { apiKey?: string }, // novelweave_change
	chutes: {} as { apiKey?: string }, // novelweave_change
