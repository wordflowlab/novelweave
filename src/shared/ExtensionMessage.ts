...
import { McpMarketplaceCatalog, McpDownloadResponse } from "./novelweave/mcp"
...
import { NovelWeaveWrapperProperties } from "./novelweave/wrapper"
...
export interface ExtensionMessage {
	type:
		...
		| "mcpDownloadDetails" // novelweave_change
		| "showSystemNotification" // novelweave_change
		| "openInBrowser" // novelweave_change
		| "acceptInput"
		...
		| "indexCleared"
		| "codebaseIndexConfig"
		| "rulesData" // novelweave_change
		| "marketplaceInstallResult"
		| "marketplaceRemoveResult"
		| "marketplaceData"
		| "mermaidFixResponse" // novelweave_change
		| "tasksByIdResponse" // novelweave_change
		| "taskHistoryResponse" // novelweave_change
		| "shareTaskSuccess"
		| "codeIndexSettingsSaved"
		| "codeIndexSecretStatus"
		| "showDeleteMessageDialog"
		| "showEditMessageDialog"
		| "novelweaveNotificationsResponse" // novelweave_change
		| "usageDataResponse" // novelweave_change
		| "keybindingsResponse" // novelweave_change
		| "commands"
	...
	mcpDownloadDetails?: McpDownloadResponse // novelweave_change
	notificationOptions?: {
		title?: string
		subtitle?: string
		message: string
	} // novelweave_change
	url?: string // novelweave_change
	keybindings?: Record<string, string> // novelweave_change
	setting?: string
	value?: any
	...
	fixedCode?: string | null // For mermaidFixResponse // novelweave_change
	errors?: string[]
	...
	context?: string
	// novelweave_change start: Notifications
	notifications?: Array<{
		id: string
		title: string
		message: string
...
export type ExtensionState = Pick<
	...
	| "globalRulesToggles" // novelweave_change
	| "localRulesToggles" // novelweave_change
...
> & {
	...
	uriScheme?: string
	uiKind?: string // novelweave_change

	kiloCodeWrapperProperties?: NovelWeaveWrapperProperties // novelweave_change: Wrapper information

	novelweaveDefaultModel: string
	shouldShowAnnouncement: boolean

	taskHistoryFullLength: number // novelweave_change
	taskHistoryVersion: number // novelweave_change
	...
	showRooIgnoredFiles: boolean // Whether to show .novelweaveignore'd files in listings
	maxReadFileLine: number // Maximum number of lines to read from a file before truncating
	showAutoApproveMenu: boolean // novelweave_change: Whether to show the auto-approve menu in the chat view
	...
	showTimestamps?: boolean // novelweave_change: Show timestamps in chat messages
}
