...
export const TOOL_DISPLAY_NAMES: Record<ToolName, string> = {
	...
	edit_file: "edit file", // novelweave_change: Morph fast apply
	...
	report_bug: "report bug", // novelweave_change
	condense: "condense the current context window", // novelweave_change
...
export const TOOL_GROUPS: Record<ToolGroup, ToolGroupConfig> = {
	...
	edit: {
		tools: [
			"apply_diff",
			"edit_file", // novelweave_change: Morph fast apply
			"write_to_file",
			"insert_content",
			"search_and_replace",
			"new_rule", // novelweave_change
			"generate_image",
		],
	},
	browser: {
