...
import { JETBRAIN_PRODUCTS, NovelWeaveWrapperProperties } from "../../shared/novelweave/wrapper"

export const getNovelWeaveWrapperProperties = (): NovelWeaveWrapperProperties => {
