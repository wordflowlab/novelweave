...
import {
	...
	ZAiHandler,
	FireworksHandler,
	SyntheticHandler, // novelweave_change
	RooHandler,
	FeatherlessHandler,
	VercelAiGatewayHandler,
	DeepInfraHandler,
	OVHcloudAIEndpointsHandler, // novelweave_change
} from "./providers"
// novelweave_change start
import { NovelweaveOpenrouterHandler } from "./providers/novelweave-openrouter"
// novelweave_change end
...
export function buildApiHandler(configuration: ProviderSettings): ApiHandler {
	...
	switch (apiProvider) {
		// novelweave_change start
		case "novelweave":
			return new NovelweaveOpenrouterHandler(options)
		case "novelweave-openrouter": // temp typing fix
			return new NovelweaveOpenrouterHandler(options)
		case "gemini-cli":
