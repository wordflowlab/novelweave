...
import {
	...
	FinishReason, // novelweave_change
} from "@google/genai"
import type { JWTInput } from "google-auth-library"

import {
	type ModelInfo,
	// type GeminiModelId, // novelweave_change
...
import { throwMaxCompletionTokensReachedError } from "./novelweave/verifyFinishReason"
import { getGeminiModels } from "./fetchers/gemini" // novelweave_change
...
export class GeminiHandler extends BaseProvider implements SingleCompletionHandler {
	...
	constructor({ isVertex, ...options }: GeminiHandlerOptions) {
		...
		this.isVertex = !!isVertex // novelweave_change
	...
	async *createMessage(
		...
		await this.ensureModelsLoaded() // novelweave_change
	...
	override getModel() {
		// novelweave_change start: dynamic loading
