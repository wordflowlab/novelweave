...
export const handleNewTask = async (
	// novelweave_change start: Add profile and mode switching support
	...
	// novelweave_change start: Handle profile and mode switching if provided
	...
	// novelweave_change end: Add profile and mode switching support
