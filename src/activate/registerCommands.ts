...
export const openClineInNewTab = async ({ context, outputChannel }: Omit<RegisterCommandOptions, "provider">) => {
	...
	newPanel.iconPath = {
		light: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "novelweave.png"),
		dark: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "novelweave-dark.png"),
	}
