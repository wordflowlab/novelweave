...
import ai.novelweave.jetbrains.util.ProxyConfigUtil
import java.io.File
import java.util.concurrent.TimeUnit
import ai.novelweave.jetbrains.util.ExtensionUtils
import ai.novelweave.jetbrains.util.PluginConstants
import ai.novelweave.jetbrains.util.NotificationUtil
import ai.novelweave.jetbrains.util.NodeVersionUtil
import ai.novelweave.jetbrains.util.NodeVersion
import ai.novelweave.jetbrains.i18n.I18n
...
//                "--trace-uncaught",
    ...
    fun findExtensionEntryFile(): String? {
        ...
        // Normal mode
        val resourcesPath = ai.novelweave.jetbrains.util.PluginResourceUtil.getResourcePath(PLUGIN_ID, "$RUNTIME_DIR/$EXTENSION_ENTRY_FILE")
        if (resourcesPath != null) {
