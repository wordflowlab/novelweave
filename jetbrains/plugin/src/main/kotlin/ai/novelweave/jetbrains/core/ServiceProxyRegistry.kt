...
package ai.novelweave.jetbrains.core

import com.intellij.openapi.components.Service
import com.intellij.openapi.diagnostic.Logger
import ai.novelweave.jetbrains.actors.*
import ai.novelweave.jetbrains.ipc.proxy.createProxyIdentifier
import ai.novelweave.jetbrains.ipc.proxy.interfaces.*
...
//
    ...
    object ExtHostContext {
        ...
        val ExtHostCommands = createProxyIdentifier<ExtHostCommandsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostCommandsProxy")
        val ExtHostConfiguration = createProxyIdentifier<ExtHostConfigurationProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostConfigurationProxy")
        ...
        val ExtHostDocumentsAndEditors = createProxyIdentifier<ExtHostDocumentsAndEditorsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsAndEditorsProxy")
        val ExtHostDocuments = createProxyIdentifier<ExtHostDocumentsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsProxy")
        ...
        val ExtHostEditors = createProxyIdentifier<ExtHostEditorsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostEditorsProxy")
        ...
        val ExtHostFileSystemEventService = createProxyIdentifier<ExtHostFileSystemEventServiceProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostFileSystemEventServiceProxy")
        ...
        val ExtHostExtensionService = createProxyIdentifier<ExtHostExtensionServiceProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostExtensionServiceProxy")
        val ExtHostLogLevelServiceShape = createProxyIdentifier<Any>("ExtHostLogLevelServiceShape")
        val ExtHostTerminalService = createProxyIdentifier<ExtHostTerminalServiceProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostTerminalServiceProxy")
        val ExtHostTerminalShellIntegration = createProxyIdentifier<ExtHostTerminalShellIntegrationProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostTerminalShellIntegrationProxy")
        ...
        val ExtHostWorkspace = createProxyIdentifier<ExtHostWorkspaceProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostWorkspaceProxy")
        val ExtHostWindow = createProxyIdentifier<Any>("ExtHostWindow")
        val ExtHostWebviews = createProxyIdentifier<ExtHostWebviewsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostWebviewsProxy")
        ...
        val ExtHostWebviewViews = createProxyIdentifier<ExtHostWebviewViewsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostWebviewViewsProxy")
        val ExtHostEditorInsets = createProxyIdentifier<Any>("ExtHostEditorInsets")
        val ExtHostEditorTabs = createProxyIdentifier<ExtHostEditorTabsProxy>("ai.novelweave.jetbrains.ipc.proxy.interfaces.ExtHostEditorTabsProxy")
