...
package ai.novelweave.jetbrains.ui
...
import ai.novelweave.jetbrains.actions.OpenDevToolsAction
import ai.novelweave.jetbrains.plugin.WecoderPlugin
import ai.novelweave.jetbrains.plugin.WecoderPluginService
import ai.novelweave.jetbrains.plugin.DEBUG_MODE
import ai.novelweave.jetbrains.webview.DragDropHandler
import ai.novelweave.jetbrains.webview.WebViewCreationCallback
import ai.novelweave.jetbrains.webview.WebViewInstance
    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            return buildString {
                ...
                if (!jcefSupported) {
                    ...
                    append("<a href='https://novelweave.ai/docs/jetbrains-troubleshooting' target='_blank' style='color: #721c24; text-decoration: underline;'>See JetBrains docs for how to enable JCEF in your IDE</a>")
                    append("</div>")
                    append("<br>")
                }
        ...
        private val knownIssuesButton = JButton("Known Issues").apply {
            ...
            addActionListener {
                ...
                BrowserUtil.browse("https://novelweave.ai/docs")
            }
        }
