...
import ai.novelweave.jetbrains.editor.EditorAndDocManager
import ai.novelweave.jetbrains.ipc.NodeSocket
import ai.novelweave.jetbrains.ipc.PersistentProtocol
import ai.novelweave.jetbrains.ipc.proxy.ResponsiveState
    ...
    private fun createInitData(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "environment" to mapOf(
                ...
                "globalStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".novelweave", "globalStorage").toString()),
                "workspaceStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".novelweave", "workspaceStorage").toString()),
