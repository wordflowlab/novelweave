...
package ai.novelweave.jetbrains.actors

import com.intellij.openapi.Disposable
import com.intellij.openapi.diagnostic.Logger
import com.intellij.openapi.project.Project
import com.intellij.openapi.project.ProjectManager
import ai.novelweave.jetbrains.events.EventBus
import ai.novelweave.jetbrains.events.ProjectEventBus
import ai.novelweave.jetbrains.events.WebviewHtmlUpdateData
import ai.novelweave.jetbrains.events.WebviewHtmlUpdateEvent
...
class MainThreadWebviews(val project: Project) : MainThreadWebviewsShape {
    ...
    override fun setHtml(handle: WebviewHandle, value: String) {
        ...
        try {
            // Replace vscode-file protocol format, using regex to match from vscode-file:/ to /novelweave/ part
            val modifiedHtml = value.replace(Regex("vscode-file:/.*?/novelweave/"), "/")
