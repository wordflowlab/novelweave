...
object CommandIds {
    ...
    const val EXPLAIN = "novelweave.explainCode"
    /** Command ID for fixing code */
    const val FIX = "novelweave.fixCode"
    /** Command ID for improving code */
    const val IMPROVE = "novelweave.improveCode"
    /** Command ID for adding to context */
    const val ADD_TO_CONTEXT = "novelweave.addToContext"
    /** Command ID for creating a new task */
    const val NEW_TASK = "novelweave.newTask"
}
